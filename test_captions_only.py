#!/usr/bin/env python3
"""Test renderer with captions only (no subtitles)."""
...
output = Path("output/samples/style2_review/gh011293_10s_captions_only.mp4")
...
job = RenderJob(
    ...
    transcription=None,  # Disable subtitles for now
)
